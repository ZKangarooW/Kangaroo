...
void WS2812_Duty(float dT)
{
    ...
    if(sys.Run_Status)
    {
        ...
        if(T>0.06f)
        {
            ...
            if(Speed.CwIcn) 
            {
                WS2812_SetColor(RGB_SZc[val1], 0xFF, 0xFF, 0xFF, 0.6f);//顺
            }
            else 
            {
                WS2812_SetColor(RGB_SZ[val1], 0xFF, 0xFF, 0xFF, 0.6f);//逆
            }
            ...
            if(Speed.CwIcn) 
            {
                WS2812_SetColor(RGB_SZc[val2], 0xFF, 0xFF, 0xFF, 0.6f);//顺
            }
            else 
            {
                WS2812_SetColor(RGB_SZ[val2], 0xFF, 0xFF, 0xFF, 0.6f);//逆
            }
        }
        if(Speed.Cw)//进入改变转向
		{
