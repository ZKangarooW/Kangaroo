...
void Display_Time(int32_t dis_time)
{
	...
	uint8_t P_B,P_S,P_G;//p模式框框中的位数取值
	...
	if(Time.Set)//假如设定时间大于0
	{
		/**************时间计算*************/
		 if(Time.Set < 3600)
		{
			SH=dis_time%3600/60/10;//计算十位单位的分钟数
			H=dis_time%3600/60%10;//计算个位单位的分钟数
			SM=dis_time%60/10;//计算十分位单位的秒钟数
			M=dis_time%60%10;//计算十分位单位的秒钟数
		}
		else
		{
...
//	/*************转速的图标*************/
//	seg19 &= 0xF7;seg19 |= 0x08;//S4图标
//	seg19 &= 0x7F;seg19 |= 0x80;//S6时间L的图标
//	
//	/*************L12的图标**************/
//	seg19 &= 0x8F;seg19 |= 0x40;//L12图标
//	
//	/*************L1的图标***************/
//	seg20 &= 0xEF;seg20 |= 0x10;//L1图标
//	
//	/*************L2的图标***************/
//	seg22 &= 0xEF;seg22 |= 0x10;//L2图标
//	
//	/*************L3的图标***************/
//	seg23 &= 0xF7;seg23 |= 0x08;//L3图标
//	
//	/*************L4的图标***************/
//	seg24 &= 0xEF;seg24 |= 0x10;//L4图标
//	
//	/*************L5的图标***************/
//	seg25 &= 0xF7;seg25 |= 0x08;//L5图标
//	
//	/*************定时的冒号的图标*******/
//	seg21 &= 0xFE;seg21 |= 0x01;//冒号的图标
...
void Show_Display(void)
{
	...
	Temp.Display_Rel = Temp.Rel;//显示设定温度
	
	Speed.Display_Rel = Speed.Rel;//显示设定转速
