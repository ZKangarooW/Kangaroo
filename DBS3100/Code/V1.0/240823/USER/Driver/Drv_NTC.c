...
//        ADC_Val2 = Temp_Calibration(ADC_R1,570, 561, 750, 736);
//    }
//    else
//    {
//        if (!HALL1 && !HALL2)//低模块
//        {
////            ADC_Val1 = ADC_R;
//            ADC_Val1 = Temp_Calibration(ADC_R,570, 583, 750, 777);
//        }
//        else
//        {
...
//    }
    ...
    if (T >= 0.2f) // 1S
    {
        ...
        Temp_v = Get_Ntc_Temp(ADC_Val1);      // 计算温度
//        Temp.Rel = (float)Temp_v*(1+20/1000);
        Temp.Rel = (float)Temp_v*1.02;
        T = 0;
    }
}
