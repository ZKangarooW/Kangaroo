...
void Lcd_Init(void)
{
	...
	__HAL_TIM_SET_COMPARE(&htim1, TIM_CHANNEL_2, 160);//背光pwm
...
void Lcd_All(void)
{
    Write_Addr_Dat_N(0,0xFF,1);
    Write_Addr_Dat_N(2,0x7F,1);
    Write_Addr_Dat_N(4,0xFF,1);
    Write_Addr_Dat_N(6,0xFF,1);
    Write_Addr_Dat_N(8,0x7F,1);
    Write_Addr_Dat_N(10,0xFF,1);
    Write_Addr_Dat_N(12,0xFF,1);
    Write_Addr_Dat_N(14,0xFF,1);
    Write_Addr_Dat_N(38,0xFF,1);
    Write_Addr_Dat_N(36,0xFE,1);
    Write_Addr_Dat_N(34,0xFF,1);
    Write_Addr_Dat_N(32,0xFE,1);
    Write_Addr_Dat_N(22,0x7F,1);
    Write_Addr_Dat_N(20,0xFF,1);
    Write_Addr_Dat_N(18,0xFF,1);
    Write_Addr_Dat_N(16,0xFF,1);
}
