    ...
    if(sys.Run_Status == 1)//启动
    {
		if((HAL_GPIO_ReadPin(KEY_UP_GPIO_Port,KEY_UP_Pin)== 1))//盖子闭合时
		{
			if(Speed.Ctrl_Speed && ((Time.DownTime_Over == 0)||(Time.Ctrl_Time)))//速度大于0和定时器没有结束
			{
				...
				{
					case 1000: Convert_Set = 7;//1018
						break;
					case 1500: Convert_Set = 13;//1510
						break;
					case 2000: Convert_Set = 22;//2014
						break;
					case 2500: Convert_Set = 32;//2500
						break;
					case 3000: Convert_Set = 44;//3010
						break;
					case 3500: Convert_Set = 61;//3514
						break;
					case 4000: Convert_Set = 80;//3984
						break;
					case 4500: Convert_Set = 104;//4498
						break;
					case 5000: Convert_Set = 129;//5010
						break;
					case 5500: Convert_Set = 148;//5507
						break;
					case 6000: Convert_Set = 168;//6010
						break;
