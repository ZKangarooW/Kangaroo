...
void ADCDMA_Init(void)
{
    ...
    Heat_Temp.Display_Temp = Heat_Temp.Rel_Temp+Calibration_Temp;//加了后开机不会显示0然后调成实际温度
    Cool_Temp.Display_Temp = Cool_Temp.Rel_Temp+Calibration_Temp;//加了后开机不会显示0然后调成实际温度
    HAL_Delay(10); // 延时
}
