...
#define RGB_NUM1 27         // 灯珠数量

#define MAX_RATE 0.9f	   // 最大亮度
#define TIMING_ONE 42	   // 发送"1"数据时间
#define TIMING_ZERO 23	   // 发送"0"数据时间

#define RESET_WORD 256
#define DUMMY_WORD 1
...
extern _WS2812_ WS2812_Status[1];
