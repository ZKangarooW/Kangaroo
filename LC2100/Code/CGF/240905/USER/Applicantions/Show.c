...
void Display(int16_t speed,int32_t time)
{
    ...
    else if(CGF.Mode == 1)//在CGF模式下，和实际速度显示“CGF“和时间显示“-----”
    {
        ...
        seg3&=0x80;seg3|=0x00;//显示"G"
        seg4&=0x80;seg4|=0x00;//显示"F"
    ...
    {
        seg1&=0x80;seg1|=0x00;//不显示
        seg2&=0x80;seg2|=0x53;//显示"P"
        seg3&=0x80;seg3|=0x00;//显示"R"
        seg4&=0x80;seg4|=0x00;//显示"P"
...
{
    if(sys.Run_Status == 1 && CGF.Mode == 0)//启动的情况下
    {
        if(Speed.Unit)
        {
