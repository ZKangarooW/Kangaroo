...
#define Clr_1625_Cs  HAL_GPIO_WritePin(GPIOA, Ht1621_CS_Pin, GPIO_PIN_RESET)//Ht1621_CS_Pin
#define Set_1625_Cs  HAL_GPIO_WritePin(GPIOA, Ht1621_CS_Pin, GPIO_PIN_SET)

#define Clr_1625_Wr  HAL_GPIO_WritePin(GPIOA, Ht1621_WR_Pin, GPIO_PIN_RESET)//Ht1621_WR_Pin
