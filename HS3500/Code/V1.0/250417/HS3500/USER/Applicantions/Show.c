    ...
    else if(sys.Setting) 
    {
        ...
        if(Temp.Up_Speed == 0)
        {
            if(Setting_ShowFlag && sys.Setting_Option == 0)
            {
                /**********加热图标**********/
                bit_Cal(8, 0x01, 0x00);
                bit_Cal(8, 0x02, 0x00);//加热图标下面的横杠
            }
            else
            {
                /**********加热图标**********/
                bit_Cal(8, 0x01, 0x01);
                bit_Cal(8, 0x02, 0x02);//加热图标下面的横杠
            }
        }
        ...
        if(Speed.Up_Speed == 0)
        {
            ...
            {
                /**********转速图标**********/
                bit_Cal(17, 0x01, 0x00);//S5
                bit_Cal(10, 0x02, 0x00);//S4
                bit_Cal(10, 0x01, 0x00);//S3
            }
            else
            {
                /**********转速图标**********/
                bit_Cal(17, 0x01, 0x01);//S5
                bit_Cal(10, 0x02, 0x02);//S4
                bit_Cal(10, 0x01, 0x01);//S3
            }
        }
...
//        bit_Cal(12, 0x01, 0x01);
        ...
        {
            case 0: bit_Cal(17, 0x01, 0x01);//S5
                    bit_Cal(10, 0x02, 0x02);//S4
                    bit_Cal(10, 0x01, 0x01);//S3
                break;
            case 1: bit_Cal(17, 0x01, 0x00);//S5
                    bit_Cal(10, 0x02, 0x02);//S4
                    bit_Cal(10, 0x01, 0x01);//S3
                break;
            case 2: bit_Cal(17, 0x01, 0x01);//S5
                    bit_Cal(10, 0x02, 0x02);//S4
                    bit_Cal(10, 0x01, 0x00);//S3
                break;
            case 3: bit_Cal(17, 0x01, 0x01);//S5
                    bit_Cal(10, 0x02, 0x00);//S4
                    bit_Cal(10, 0x01, 0x01);//S3
                break;
            default:
