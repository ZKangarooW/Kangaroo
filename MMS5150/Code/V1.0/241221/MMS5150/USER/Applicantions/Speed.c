...
void HAL_TIM_IC_CaptureCallback(TIM_HandleTypeDef *htim)
{
    if (htim->Instance == TIM3)
    {
        ...
        {
            capture1[8] = __HAL_TIM_GET_COMPARE(&htim3, TIM_CHANNEL_1);//获取Tim3通道1的输入捕获
        ...
        {
            capture1[11] = __HAL_TIM_GET_COMPARE(&htim3, TIM_CHANNEL_3);//获取Tim3通道3的输入捕获
    ...
    if (htim->Instance == TIM2)
    {
        if (htim->Channel == HAL_TIM_ACTIVE_CHANNEL_1)
        {
            capture1[2] = __HAL_TIM_GET_COMPARE(&htim2, TIM_CHANNEL_1);//获取Tim3通道1的输入捕获
        ...
        if (htim->Channel == HAL_TIM_ACTIVE_CHANNEL_3)
        {
            capture1[5] = __HAL_TIM_GET_COMPARE(&htim2, TIM_CHANNEL_3);//获取Tim3通道3的输入捕获
    ...
    if (htim->Instance == TIM4)
    {
        if (htim->Channel == HAL_TIM_ACTIVE_CHANNEL_1)
        {
            capture1[6] = __HAL_TIM_GET_COMPARE(&htim4, TIM_CHANNEL_1);//获取Tim3通道1的输入捕获
        ...
        if (htim->Channel == HAL_TIM_ACTIVE_CHANNEL_3)
        {
            capture1[12] = __HAL_TIM_GET_COMPARE(&htim4, TIM_CHANNEL_3);//获取Tim3通道3的输入捕获
    ...
    if (htim->Instance == TIM8)
    {
        if (htim->Channel == HAL_TIM_ACTIVE_CHANNEL_1)
        {
            capture1[14] = __HAL_TIM_GET_COMPARE(&htim8, TIM_CHANNEL_1);//获取Tim3通道1的输入捕获
        ...
        if (htim->Channel == HAL_TIM_ACTIVE_CHANNEL_3)
        {
            capture1[0] = __HAL_TIM_GET_COMPARE(&htim8, TIM_CHANNEL_3);//获取Tim3通道3的输入捕获
            CaptureChanneCallback(0);
        }
        if (htim->Channel == HAL_TIM_ACTIVE_CHANNEL_4)
        {
            capture1[3] = __HAL_TIM_GET_COMPARE(&htim8, TIM_CHANNEL_4);//获取Tim3通道4的输入捕获
