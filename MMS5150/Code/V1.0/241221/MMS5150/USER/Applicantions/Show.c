...
void Display(_Work_Num_ work_num[])
{
    ...
    /***********工位1**********/
    if (work_num[0].Speed.Ctrl > 999) // 大于999时
    {
        Val = work_num[0].Speed.Ctrl / 1000 % 10;
        if(Val > 0)
        {
    ...
    if (work_num[0].Speed.Ctrl > 99) // 大于99时
    {
        Val = work_num[0].Speed.Ctrl / 100 % 10;
        switch (Val)
        {
        case 0:
    ...
    if (work_num[0].Speed.Ctrl > 9) // 大于9时
    {
        Val = work_num[0].Speed.Ctrl / 10 % 10;
        switch (Val)
        {
        case 0:
    ...
    /***********工位2**********/
    if (work_num[1].Speed.Ctrl > 999) // 大于999时
    {
        Val = work_num[1].Speed.Ctrl / 1000 % 10;
        if(Val > 0)
        {
    ...
    if (work_num[1].Speed.Ctrl > 99) // 大于99时
    {
        Val = work_num[1].Speed.Ctrl / 100 % 10;
        switch (Val)
        {
        case 0:
    ...
    if (work_num[1].Speed.Ctrl > 9) // 大于9时
    {
        Val = work_num[1].Speed.Ctrl / 10 % 10;
        switch (Val)
        {
        case 0:
    ...
    /***********工位3**********/
    if (work_num[2].Speed.Ctrl > 999) // 大于999时
    {
        Val = work_num[2].Speed.Ctrl / 1000 % 10;
        if(Val > 0)
        {
    ...
    if (work_num[2].Speed.Ctrl > 99) // 大于99时
    {
        Val = work_num[2].Speed.Ctrl / 100 % 10;
        switch (Val)
        {
        case 0:
    ...
    if (work_num[2].Speed.Ctrl > 9) // 大于9时
    {
        Val = work_num[2].Speed.Ctrl / 10 % 10;
        switch (Val)
        {
        case 0:
    ...
    /***********工位4**********/
    if (work_num[3].Speed.Ctrl > 999)//大于999时
    {
        Val = work_num[3].Speed.Ctrl / 1000 % 10;
        if(Val > 0)
        {
    ...
    if (work_num[3].Speed.Ctrl > 99)//大于99时
    {
        Val = work_num[3].Speed.Ctrl / 100 % 10;
        switch (Val)
        {
        case 0:
    ...
    if (work_num[3].Speed.Ctrl > 9) // 大于9时
    {
        Val = work_num[3].Speed.Ctrl / 10 % 10;
        switch (Val)
        {
        case 0:
    ...
    /***********工位5**********/
    if (work_num[4].Speed.Ctrl > 999)//大于999时
    {
        Val = work_num[4].Speed.Ctrl / 1000 % 10;
        if(Val > 0)
        {
    ...
    if (work_num[4].Speed.Ctrl > 99)//大于99时
    {
        Val = work_num[4].Speed.Ctrl / 100 % 10;
        switch (Val)
        {
        case 0:
    ...
    if (work_num[4].Speed.Ctrl > 9) // 大于9时
    {
        Val = work_num[4].Speed.Ctrl / 10 % 10;
        switch (Val)
        {
        case 0:
    ...
    /***********工位6**********/
    if (work_num[5].Speed.Ctrl > 999)//大于999时
    {
        Val = work_num[5].Speed.Ctrl / 1000 % 10;
        if(Val > 0)
        {
    ...
    if (work_num[5].Speed.Ctrl > 99)//大于99时
    {
        Val = work_num[5].Speed.Ctrl / 100 % 10;
        switch (Val)
        {
        case 0:
    ...
    if (work_num[5].Speed.Ctrl > 9) // 大于9时
    {
        Val = work_num[5].Speed.Ctrl / 10 % 10;
        switch (Val)
        {
        case 0:
    ...
    /***********工位7**********/
    if (work_num[6].Speed.Ctrl > 999)//大于999时
    {
        Val = work_num[6].Speed.Ctrl / 1000 % 10;
        if(Val > 0)
        {
    ...
    if (work_num[6].Speed.Ctrl > 99)//大于99时
    {
        Val = work_num[6].Speed.Ctrl / 100 % 10;
        switch (Val)
        {
        case 0:
    ...
    else
    {
     ...
     if (work_num[6].Speed.Ctrl > 9) // 大于9时
    {
        Val = work_num[6].Speed.Ctrl / 10 % 10;
        switch (Val)
        {
        case 0:
    ...
    /***********工位8**********/
    if (work_num[7].Speed.Ctrl > 999)//大于999时
    {
        Val = work_num[7].Speed.Ctrl / 1000 % 10;
        if(Val > 0)
        {
    ...
    if (work_num[7].Speed.Ctrl > 99)//大于99时
    {
        Val = work_num[7].Speed.Ctrl / 100 % 10;
        switch (Val)
        {
        case 0:
    ...
    if (work_num[7].Speed.Ctrl > 9) // 大于9时
    {
        Val = work_num[7].Speed.Ctrl / 10 % 10;
        switch (Val)
        {
        case 0:
    ...
    /***********工位9**********/
    if (work_num[8].Speed.Ctrl > 999)//大于999时
    {
        Val = work_num[8].Speed.Ctrl / 1000 % 10;
        if(Val > 0)
        {
    ...
    if (work_num[8].Speed.Ctrl > 99)//大于99时
    {
        Val = work_num[8].Speed.Ctrl / 100 % 10;
        switch (Val)
        {
        case 0:
    ...
    if (work_num[8].Speed.Ctrl > 9) // 大于9时
    {
        Val = work_num[8].Speed.Ctrl / 10 % 10;
        switch (Val)
        {
        case 0:
        ...
        case 5:
            ...
            break;
        case 6:
            bit_Cal(20, 0x0E, 0x06);bit_Cal(21, 0x0F, 0x0F);
            break;
        case 7:
    ...
    /***********工位10**********/
    if (work_num[9].Speed.Ctrl > 999)//大于999时
    {
        Val = work_num[9].Speed.Ctrl / 1000 % 10;
        if(Val > 0)
        {
    ...
    if (work_num[9].Speed.Ctrl > 99)//大于99时
    {
        Val = work_num[9].Speed.Ctrl / 100 % 10;
        switch (Val)
        {
        case 0:
    ...
    if (work_num[9].Speed.Ctrl > 9) // 大于9时
    {
        Val = work_num[9].Speed.Ctrl / 10 % 10;
        switch (Val)
        {
        case 0:
    ...
    /***********工位11**********/
    if (work_num[10].Speed.Ctrl > 999)//大于999时
    {
        Val = work_num[10].Speed.Ctrl / 1000 % 10;
        if(Val > 0)
        {
    ...
    if (work_num[10].Speed.Ctrl > 99)//大于99时
    {
        Val = work_num[10].Speed.Ctrl / 100 % 10;
        switch (Val)
        {
        case 0:
    ...
    if (work_num[10].Speed.Ctrl > 9) // 大于9时
    {
        Val = work_num[10].Speed.Ctrl / 10 % 10;
        switch (Val)
        {
        case 0:
    ...
    /***********工位12**********/
    if (work_num[11].Speed.Ctrl > 999)//大于999时
    {
        Val = work_num[11].Speed.Ctrl / 1000 % 10;
        if(Val > 0)
        {
    ...
    if (work_num[11].Speed.Ctrl > 99)//大于99时
    {
        Val = work_num[11].Speed.Ctrl / 100 % 10;
        switch (Val)
        {
        case 0:
    ...
    if (work_num[11].Speed.Ctrl > 9) // 大于9时
    {
        Val = work_num[11].Speed.Ctrl / 10 % 10;
        switch (Val)
        {
        case 0:
    ...
    /***********工位13**********/
    if (work_num[12].Speed.Ctrl > 999)//大于999时
    {
        Val = work_num[12].Speed.Ctrl / 1000 % 10;
        if(Val > 0)
        {
    ...
    if (work_num[12].Speed.Ctrl > 99)//大于99时
    {
        Val = work_num[12].Speed.Ctrl / 100 % 10;
        switch (Val)
        {
        case 0:
        ...
        case 5:
            ...
            break;
        case 6:
            bit_Cal(43, 0x0E, 0x06);bit_Cal(44, 0x0F, 0x0F);
            break;
        case 7:
    ...
    if (work_num[12].Speed.Ctrl > 9) // 大于9时
    {
        Val = work_num[12].Speed.Ctrl / 10 % 10;
        switch (Val)
        {
        case 0:
        ...
        case 5:
            ...
            break;
        case 6:
            bit_Cal(41, 0x0E, 0x06);bit_Cal(42, 0x0F, 0x0F);
            break;
        case 7:
    ...
    /***********工位14**********/
    if (work_num[13].Speed.Ctrl > 999)//大于999时
    {
        Val = work_num[13].Speed.Ctrl / 1000 % 10;
        if(Val > 0)
        {
    ...
    if (work_num[13].Speed.Ctrl > 99)//大于99时
    {
        Val = work_num[13].Speed.Ctrl / 100 % 10;
        switch (Val)
        {
        case 0:
    ...
    if (work_num[13].Speed.Ctrl > 9) // 大于9时
    {
        Val = work_num[13].Speed.Ctrl / 10 % 10;
        switch (Val)
        {
        case 0:
    ...
    /***********工位15**********/
    if (work_num[14].Speed.Ctrl > 999)//大于999时
    {
        Val = work_num[14].Speed.Ctrl / 1000 % 10;
        if(Val > 0)
        {
    ...
    if (work_num[14].Speed.Ctrl > 99)//大于99时
    {
        Val = work_num[14].Speed.Ctrl / 100 % 10;
        switch (Val)
        {
        case 0:
    ...
    if (work_num[14].Speed.Ctrl > 9) // 大于9时
    {
        Val = work_num[14].Speed.Ctrl / 10 % 10;
        switch (Val)
        {
        case 0:
    ...
    if(work_num[sys.New_Work].Speed.Display_Rel)
    {
        switch(Work_Num[0].Speed.IconStep)
        {
            case 0: bit_Cal(15, 0x04, 0x04);//工位转速图标S48
                ...
                break;
            case 1: bit_Cal(15, 0x04, 0x04);//工位转速图标S48
                    bit_Cal(15, 0x08, 0x08);//工位转速图标S49
            ...
            case 2: bit_Cal(15, 0x04, 0x04);//工位转速图标S48
                    ...
                    bit_Cal(16, 0x08, 0x08);//工位转速图标S50
                break;
            case 3: bit_Cal(15, 0x04, 0x00);//工位转速图标S48
                    bit_Cal(15, 0x08, 0x08);//工位转速图标S49
                    bit_Cal(16, 0x08, 0x08);//工位转速图标S50
                break;
            default:
