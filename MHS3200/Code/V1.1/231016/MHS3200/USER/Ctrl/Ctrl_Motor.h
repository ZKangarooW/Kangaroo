...
/**********宏定义************/
    ...
    #define PWM_L1 htim2.Instance->CCR1//motor1 PWM输出 （0~200）
    #define PWM_L2 htim2.Instance->CCR4//motor4 PWM输出 （0~200）
    #define PWM_L5 htim2.Instance->CCR2//motor2 PWM输出 （0~200）
    #define PWM_L6 htim2.Instance->CCR3//motor3 PWM输出 （0~200）
