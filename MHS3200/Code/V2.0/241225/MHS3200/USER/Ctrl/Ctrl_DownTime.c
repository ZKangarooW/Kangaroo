...
void Cheak_TimeDown(uint16_t dT)
{
    ...
    if(Run_Status)//启动系统
    {
        ...
        if(T == 1000)//1S
        {
            if(RelTime_State.L1 && DownTime_Over.L1 == 0)//如果实际时间显示和倒计时没有结束的标志还在
            {
                if(Ctrl_Time.L1)
                    Ctrl_Time.L1--;//控制时间--
                else
            ...
            if(RelTime_State.L2 && DownTime_Over.L2 == 0)//如果实际时间显示和倒计时没有结束的标志还在
            {
                if(Ctrl_Time.L2)
                    Ctrl_Time.L2--;//控制时间--
                else
            ...
            if(RelTime_State.L3 && DownTime_Over.L3 == 0)//如果实际时间显示和倒计时没有结束的标志还在
            {
                if(Ctrl_Time.L3)
                    Ctrl_Time.L3--;//控制时间--
                else
            ...
            if(RelTime_State.L4 && DownTime_Over.L4 == 0)//如果实际时间显示和倒计时没有结束的标志还在
            {
                if(Ctrl_Time.L4)
                    Ctrl_Time.L4--;//控制时间--
                else
            ...
            if(RelTime_State.L5 && DownTime_Over.L5 == 0)//如果实际时间显示和倒计时没有结束的标志还在
            {
                if(Ctrl_Time.L5)
                    Ctrl_Time.L5--;//控制时间--
                else
            ...
            if(RelTime_State.L6 && DownTime_Over.L6 == 0)//如果实际时间显示和倒计时没有结束的标志还在
            {
                if(Ctrl_Time.L6)
                    Ctrl_Time.L6--;//控制时间--
                else
            ...
            if(RelTime_State.L7 && DownTime_Over.L7 == 0)//如果实际时间显示和倒计时没有结束的标志还在
            {
                if(Ctrl_Time.L7)
                    Ctrl_Time.L7--;//控制时间--
                else
            ...
            if(RelTime_State.L8 && DownTime_Over.L8 == 0)//如果实际时间显示和倒计时没有结束的标志还在
            {
                if(Ctrl_Time.L8)
                    Ctrl_Time.L8--;//控制时间--
                else
			...
			if(RelTime_State.L9 && DownTime_Over.L9 == 0)//如果实际时间显示和倒计时没有结束的标志还在
            {
                if(Ctrl_Time.L9)
                    Ctrl_Time.L9--;//控制时间--
                else
