		...
		{   
			if(Key_Cnt5 < 1.5)//小于1.5S是单击
			{
				...
				else if(sys.SetMode_Option == 3)//设置速度
				{
					...
					if(Set_Speed > 14100)//离心率大于14100时
						Set_Speed = 14100;//离心率等于14100
					}
					else
					{
						Set_Speed += 100;//速度加100
						if(Set_Speed > 14500)//速度大于14500时
							Set_Speed = 14500;//速度等于14500
					}
                    #elif(Type == 1)//13PRO
					if(Speed_Mode)
					{
						if(Set_Speed == 70)
							...
							Set_Speed += 100;//离心率加100
						if(Set_Speed > 11300)//离心率大于11300时
							Set_Speed = 11300;//离心率等于11300
					}
					else
					{
						Set_Speed += 100;//速度加100
						if(Set_Speed > 13000)//速度大于13000时
							Set_Speed = 13000;//速度等于13000
					}
                    #elif(Type == 2)//12PRO
					if(Speed_Mode)
					{
						if(Set_Speed == 70)
							...
							Set_Speed += 100;//离心率加100
						if(Set_Speed > 10000)//离心率大于10000时
							Set_Speed = 10000;//离心率等于10000
					}
					else
					{
						Set_Speed += 100;//速度加100
						if(Set_Speed > 12000)//速度大于12000时
							Set_Speed = 12000;//速度等于12000
					}
					#endif
				}
