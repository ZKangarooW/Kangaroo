...
void Display_IC1(_Speed_ speed[], _Temp_ temp[],_Time_ time[])
{
    ...
    if (speed[0].Display_Rel > 999) // 大于999时
    {
       ...
       if(Val > 0)
        {
            bit_Cal(2, 0x01, 0x00);
            bit_Cal(3, 0x01, 0x01);//显示数字1
        }
       else
       {
            bit_Cal(2, 0x01, 0x01);
            bit_Cal(3, 0x01, 0x01);//显示数字0
       }
    }
    else
    {
       ...
       if(Val > 0)
        {
            ...
            bit_Cal(12, 0x01, 0x01);//显示数字1
        }
       else
       {
            bit_Cal(11, 0x01, 0x01);
            bit_Cal(12, 0x01, 0x01);//显示数字0
       }
    }
    else
    {
   ...
   if (speed[0].Display_Set > 99) // 大于99时
   {
       ...
       {
       case 0:
            bit_Cal(13, 0x03, 0x03);
            bit_Cal(14, 0x07, 0x05);
            bit_Cal(15, 0x03, 0x03);
            break;
       case 1:
            bit_Cal(13, 0x03, 0x00);
            bit_Cal(14, 0x07, 0x00);
            bit_Cal(15, 0x03, 0x03);
            break;
       case 2:
            bit_Cal(13, 0x03, 0x02);
            bit_Cal(14, 0x07, 0x07);
            bit_Cal(15, 0x03, 0x01);
            break;
       case 3:
            bit_Cal(13, 0x03, 0x00);
            bit_Cal(14, 0x07, 0x07);
            ...
            break;
       case 4:
            bit_Cal(13, 0x03, 0x01);
            bit_Cal(14, 0x07, 0x02);
            bit_Cal(15, 0x03, 0x03);
            break;
       case 5:
            bit_Cal(13, 0x03, 0x01);
            bit_Cal(14, 0x07, 0x07);
            bit_Cal(15, 0x03, 0x02);
            break;
       case 6:
            bit_Cal(13, 0x03, 0x03);
            bit_Cal(14, 0x07, 0x07);
   ...
   if (speed[0].Display_Set > 9) // 大于9时
   {
       ...
       {
       case 0:
            bit_Cal(16, 0x03, 0x03);
            bit_Cal(17, 0x07, 0x05);
            bit_Cal(18, 0x03, 0x03);
            break;
       case 1:
            bit_Cal(16, 0x03, 0x00);
            bit_Cal(17, 0x07, 0x00);
            bit_Cal(18, 0x03, 0x03);
            break;
       case 2:
            bit_Cal(16, 0x03, 0x02);
            bit_Cal(17, 0x07, 0x07);
            bit_Cal(18, 0x03, 0x01);
            break;
       case 3:
            bit_Cal(16, 0x03, 0x00);
            bit_Cal(17, 0x07, 0x07);
            ...
            break;
       case 4:
            bit_Cal(16, 0x03, 0x01);
            bit_Cal(17, 0x07, 0x02);
            bit_Cal(18, 0x03, 0x03);
            break;
       case 5:
            bit_Cal(16, 0x03, 0x01);
            bit_Cal(17, 0x07, 0x07);
            bit_Cal(18, 0x03, 0x02);
            break;
       case 6:
            bit_Cal(16, 0x03, 0x03);
            bit_Cal(17, 0x07, 0x07);
