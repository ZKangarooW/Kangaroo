 ...
 */
void Display_IC2(_Speed_ speed[], _Temp_ temp[],_Time_ time[])
{
    uint8_t Val;// 用于百十个取出来的数字

    /*******************************1号工位*******************************/
    /**********工位1的实际转速显示**********/
    if (speed[0].Display_Rel > 999) // 大于999时
    {
        Val = speed[0].Display_Rel / 1000 % 10;
       if(Val > 0)
        {
   ...
   if (speed[0].Display_Rel > 99) // 大于99时
   {
       Val = speed[0].Display_Rel / 100 % 10;
       switch (Val)
       {
       case 0:
   ...
   if (speed[0].Display_Rel > 9) // 大于9时
   {
       Val = speed[0].Display_Rel / 10 % 10;
       switch (Val)
       {
       case 0:
   ...
   else
   {
    ...
    /**********工位1的设定转速显示**********/
    if (speed[0].Display_Set > 999) // 大于999时
    {
        Val = speed[0].Display_Set / 1000 % 10;
       if(Val > 0)
        {
   ...
   if (speed[0].Display_Set > 99) // 大于99时
   {
       Val = speed[0].Display_Set / 100 % 10;
       switch (Val)
       {
       case 0:
   ...
   if (speed[0].Display_Set > 9) // 大于9时
   {
       Val = speed[0].Display_Set / 10 % 10;
       switch (Val)
       {
       case 0:
   ...
   else
   {
    ...
    /**********工位1的实际温度显示**********/
    if (temp[0].Display_Rel >= 0)//大于等于0时
    {
        Val = temp[0].Display_Rel / 1000 % 10;
    }
    else if (temp[0].Display_Rel < 0 && temp[0].Display_Rel > -100)
    {
        Val = ABS(temp[0].Display_Rel) / 1000 % 10;//计算后是0，不大于999所以不会显示
    }
    else if (temp[0].Display_Rel <= -100 && temp[0].Display_Rel > -1000)
    {
        Val = 10;//显示“-”
    }
    switch (Val)
    ...
    {
        Val = ABS(temp[0].Display_Rel)/ 100 % 10;
    }
    switch (Val)
    {
        case 0:
            if (temp[0].Display_Rel > 99)//显示零
            {
    ...
    if (temp[0].Display_Rel >= 0)//大于等于0时
    {
        Val = temp[0].Display_Rel / 10 % 10;
    }
    else if (temp[0].Display_Rel < 0 && temp[0].Display_Rel > -100)
    {
        Val = ABS(temp[0].Display_Rel) / 10 % 10;
    }
    else if (temp[0].Display_Rel <= -100 && temp[0].Display_Rel > -1000)
    {
        Val = ABS(temp[0].Display_Rel) / 10 % 10;
    ...
    /**********工位1的设定温度显示**********/
    if (temp[0].Display_Set >= 0)//大于等于0时
    {
        Val = temp[0].Display_Set / 1000 % 10;
    }
    else if (temp[0].Display_Set < 0 && temp[0].Display_Set > -100)
    {
        Val = ABS(temp[0].Display_Set) / 1000 % 10;//计算后是0，不大于999所以不会显示
    }
    else if (temp[0].Display_Set <= -100 && temp[0].Display_Set > -1000)
    {
        Val = 10;//显示“-”
    }
    switch (Val)
    ...
    {
        Val = ABS(temp[0].Display_Set)/ 100 % 10;
    }
    switch (Val)
    {
        case 0:
            if (temp[0].Display_Set > 99)//显示零
            {
    ...
    if (temp[0].Display_Set >= 0)//大于等于0时
    {
        Val = temp[0].Display_Set / 10 % 10;
    }
    else if (temp[0].Display_Set < 0 && temp[0].Display_Set > -100)
    {
        Val = ABS(temp[0].Display_Set) / 10 % 10;
    }
    else if (temp[0].Display_Set <= -100 && temp[0].Display_Set > -1000)
    {
        Val = ABS(temp[0].Display_Set) / 10 % 10;
    ...
    /**********工位1的实际时间显示**********/
    Val = time[0].Display_Rel / 3600 / 10;//计算十位为单位的小时数
    switch (Val)
    {
        case 0:
    ...
    Val = time[0].Display_Rel / 3600 % 10;// 计算个位为单位的小时数
    switch (Val)
    {
        case 0:
    ...
    Val = time[0].Display_Rel % 3600 / 60 / 10; // 计算十分位为单位的分钟数
    switch (Val)
    {
        case 0:
    ...
    Val = time[0].Display_Rel % 3600 / 60 % 10;	// 计算个分位为单位的分钟数
    switch (Val)
    {
        case 0:
    ...
    /**********工位1的设定时间显示**********/
    Val = time[0].Display_Set / 3600 / 10;//计算十位为单位的小时数
    switch (Val)
    {
        case 0:
    ...
    Val = time[0].Display_Set / 3600 % 10;// 计算个位为单位的小时数
    switch (Val)
    {
        case 0:
    ...
    Val = time[0].Display_Set % 3600 / 60 / 10; // 计算十分位为单位的分钟数
    switch (Val)
    {
        case 0:
    ...
    Val = time[0].Display_Set % 3600 / 60 % 10;	// 计算个分位为单位的分钟数
    switch (Val)
    {
        case 0:
    ...
    /*******************************2号工位*******************************/
    /**********工位2的实际转速显示**********/
    if (speed[1].Display_Rel > 999) // 大于999时
    {
        Val = speed[1].Display_Rel / 1000 % 10;
       if(Val > 0)
        {
   ...
   if (speed[1].Display_Rel > 99) // 大于99时
   {
       Val = speed[1].Display_Rel / 100 % 10;
       switch (Val)
       {
       case 0:
   ...
   if (speed[1].Display_Rel > 9) // 大于9时
   {
       Val = speed[1].Display_Rel / 10 % 10;
       switch (Val)
       {
       case 0:
   ...
   else
   {
    ...
    /**********工位2的设定转速显示**********/
    if (speed[1].Display_Set > 999) // 大于999时
    {
        Val = speed[1].Display_Set / 1000 % 10;
       if(Val > 0)
        {
   ...
   if (speed[1].Display_Set > 99) // 大于99时
   {
       Val = speed[1].Display_Set / 100 % 10;
       switch (Val)
       {
       case 0:
   ...
   if (speed[1].Display_Set > 9) // 大于9时
   {
       Val = speed[1].Display_Set / 10 % 10;
       switch (Val)
       {
       case 0:
   ...
   else
   {
    ...
    /**********工位2的实际温度显示**********/
    if (temp[1].Display_Rel >= 0)//大于等于0时
    {
        Val = temp[1].Display_Rel / 1000 % 10;
    }
    else if (temp[1].Display_Rel < 0 && temp[1].Display_Rel > -100)
    {
        Val = ABS(temp[1].Display_Rel) / 1000 % 10;//计算后是0，不大于999所以不会显示
    }
    else if (temp[1].Display_Rel <= -100 && temp[1].Display_Rel > -1000)
    {
        Val = 10;//显示“-”
    }
    switch (Val)
    ...
    {
        Val = ABS(temp[1].Display_Rel)/ 100 % 10;
    }
    switch (Val)
    {
        case 0:
            if (temp[1].Display_Rel > 99)//显示零
            {
    ...
    if (temp[1].Display_Rel >= 0)//大于等于0时
    {
        Val = temp[1].Display_Rel / 10 % 10;
    }
    else if (temp[1].Display_Rel < 0 && temp[1].Display_Rel > -100)
    {
        Val = ABS(temp[1].Display_Rel) / 10 % 10;
    }
    else if (temp[1].Display_Rel <= -100 && temp[1].Display_Rel > -1000)
    {
        Val = ABS(temp[1].Display_Rel) / 10 % 10;
    ...
    /**********工位2的设定温度显示**********/
    if (temp[1].Display_Set >= 0)//大于等于0时
    {
        Val = temp[1].Display_Set / 1000 % 10;
    }
    else if (temp[1].Display_Set < 0 && temp[1].Display_Set > -100)
    {
        Val = ABS(temp[1].Display_Set) / 1000 % 10;//计算后是0，不大于999所以不会显示
    }
    else if (temp[1].Display_Set <= -100 && temp[1].Display_Set > -1000)
    {
        Val = 10;//显示“-”
    }
    switch (Val)
    ...
    {
        Val = ABS(temp[1].Display_Set)/ 100 % 10;
    }
    switch (Val)
    {
        case 0:
            if (temp[1].Display_Set > 99)//显示零
            {
    ...
    if (temp[1].Display_Set >= 0)//大于等于0时
    {
        Val = temp[1].Display_Set / 10 % 10;
    }
    else if (temp[1].Display_Set < 0 && temp[1].Display_Set > -100)
    {
        Val = ABS(temp[1].Display_Set) / 10 % 10;
    }
    else if (temp[1].Display_Set <= -100 && temp[1].Display_Set > -1000)
    {
        Val = ABS(temp[1].Display_Set) / 10 % 10;
    ...
    /**********工位2的实际时间显示**********/
    Val = time[1].Display_Rel / 3600 / 10;//计算十位为单位的小时数
    switch (Val)
    {
        case 0:
    ...
    Val = time[1].Display_Rel / 3600 % 10;// 计算个位为单位的小时数
    switch (Val)
    {
        case 0:
    ...
    Val = time[1].Display_Rel % 3600 / 60 / 10; // 计算十分位为单位的分钟数
    switch (Val)
    {
        case 0:
    ...
    Val = time[1].Display_Rel % 3600 / 60 % 10;	// 计算个分位为单位的分钟数
    switch (Val)
    {
        case 0:
    ...
    /**********工位2的设定时间显示**********/
    Val = time[1].Display_Set / 3600 / 10;//计算十位为单位的小时数
    switch (Val)
    {
        case 0:
    ...
    Val = time[1].Display_Set / 3600 % 10;// 计算个位为单位的小时数
    switch (Val)
    {
        case 0:
    ...
    Val = time[1].Display_Set % 3600 / 60 / 10; // 计算十分位为单位的分钟数
    switch (Val)
    {
        case 0:
    ...
    Val = time[1].Display_Set % 3600 / 60 % 10;	// 计算个分位为单位的分钟数
    switch (Val)
    {
        case 0:
...
void Display_IC1(_Speed_ speed[], _Temp_ temp[],_Time_ time[])
{
    uint8_t Val;// 用于百十个取出来的数字

    /*******************************3号工位*******************************/
    /**********工位3的实际转速显示**********/
    if (speed[2].Display_Rel > 999) // 大于999时
    {
        Val = speed[2].Display_Rel / 1000 % 10;
       if(Val > 0)
        {
   ...
   if (speed[2].Display_Rel > 99) // 大于99时
   {
       Val = speed[2].Display_Rel / 100 % 10;
       switch (Val)
       {
       case 0:
   ...
   if (speed[2].Display_Rel > 9) // 大于9时
   {
       Val = speed[2].Display_Rel / 10 % 10;
       switch (Val)
       {
       case 0:
   ...
   else
   {
    ...
    /**********工位3的设定转速显示**********/
    if (speed[2].Display_Set > 999) // 大于999时
    {
        Val = speed[2].Display_Set / 1000 % 10;
       if(Val > 0)
        {
   ...
   if (speed[2].Display_Set > 99) // 大于99时
   {
       Val = speed[2].Display_Set / 100 % 10;
       switch (Val)
       {
       case 0:
   ...
   if (speed[2].Display_Set > 9) // 大于9时
   {
        Val = speed[2].Display_Set / 10 % 10;
        switch (Val)
        {
            case 0:
    ...
    /**********工位3的实际温度显示**********/
    if (temp[2].Display_Rel >= 0)//大于等于0时
    {
        Val = temp[2].Display_Rel / 1000 % 10;
    }
    else if (temp[2].Display_Rel < 0 && temp[2].Display_Rel > -100)
    {
        Val = ABS(temp[2].Display_Rel) / 1000 % 10;//计算后是0，不大于999所以不会显示
    }
    else if (temp[2].Display_Rel <= -100 && temp[2].Display_Rel > -1000)
    {
        Val = 10;//显示“-”
    }
    switch (Val)
    ...
    {
        Val = ABS(temp[2].Display_Rel)/ 100 % 10;
    }
    switch (Val)
    {
        case 0:
            if (temp[2].Display_Rel > 99)//显示零
            {
    ...
    if (temp[2].Display_Rel >= 0)//大于等于0时
    {
        Val = temp[2].Display_Rel / 10 % 10;
    }
    else if (temp[2].Display_Rel < 0 && temp[2].Display_Rel > -100)
    {
        Val = ABS(temp[2].Display_Rel) / 10 % 10;
    }
    else if (temp[2].Display_Rel <= -100 && temp[2].Display_Rel > -1000)
    {
        Val = ABS(temp[2].Display_Rel) / 10 % 10;
    ...
    /**********工位3的设定温度显示**********/
    if (temp[2].Display_Set >= 0)//大于等于0时
    {
        Val = temp[2].Display_Set / 1000 % 10;
    }
    else if (temp[2].Display_Set < 0 && temp[2].Display_Set > -100)
    {
        Val = ABS(temp[2].Display_Set) / 1000 % 10;//计算后是0，不大于999所以不会显示
    }
    else if (temp[2].Display_Set <= -100 && temp[2].Display_Set > -1000)
    {
        Val = 10;//显示“-”
    }
    switch (Val)
    ...
    {
        Val = ABS(temp[2].Display_Set)/ 100 % 10;
    }
    switch (Val)
    {
        case 0:
    ...
    if (temp[2].Display_Set >= 0)//大于等于0时
    {
        Val = temp[2].Display_Set / 10 % 10;
    }
    else if (temp[2].Display_Set < 0 && temp[2].Display_Set > -100)
    {
        Val = ABS(temp[2].Display_Set) / 10 % 10;
    }
    else if (temp[2].Display_Set <= -100 && temp[2].Display_Set > -1000)
    {
        Val = ABS(temp[2].Display_Set) / 10 % 10;
    ...
    bit_Cal(63, 0x20, 0x20);
     ...
     /**********工位3的实际时间显示**********/
    Val = time[2].Display_Rel / 3600 / 10;//计算十位为单位的小时数
    switch (Val)
    {
        case 0:
    ...
    Val = time[2].Display_Rel / 3600 % 10;// 计算个位为单位的小时数
    switch (Val)
    {
        case 0:
    ...
    Val = time[2].Display_Rel % 3600 / 60 / 10; // 计算十分位为单位的分钟数
    switch (Val)
    {
        case 0:
    ...
    Val = time[2].Display_Rel % 3600 / 60 % 10;	// 计算个分位为单位的分钟数
    switch (Val)
    {
        case 0:
    ...
    /**********工位3的设定时间显示**********/
    Val = time[2].Display_Set / 3600 / 10;//计算十位为单位的小时数
    switch (Val)
    {
         case 0:
    ...
    Val = time[2].Display_Set / 3600 % 10;// 计算个位为单位的小时数
    switch (Val)
    {
        case 0:
    ...
    Val = time[2].Display_Set % 3600 / 60 / 10; // 计算十分位为单位的分钟数
    switch (Val)
    {
        case 0:
    ...
    Val = time[2].Display_Set % 3600 / 60 % 10;	// 计算个分位为单位的分钟数
    switch (Val)
    {
        case 0:
    ...
    /*******************************4号工位*******************************/
    /**********工位4的实际转速显示**********/
    if (speed[3].Display_Rel > 999) // 大于999时
    {
        Val = speed[3].Display_Rel / 1000 % 10;
       if(Val > 0)
        {
   ...
   if (speed[3].Display_Rel > 99) // 大于99时
   {
       Val = speed[3].Display_Rel / 100 % 10;
       switch (Val)
       {
       case 0:
   ...
   if (speed[3].Display_Rel > 9) // 大于9时
   {
       Val = speed[3].Display_Rel / 10 % 10;
       switch (Val)
       {
       case 0:
   ...
   else
   {
    ...
    /**********工位4的设定转速显示**********/
    if (speed[3].Display_Set > 999) // 大于999时
    {
        Val = speed[3].Display_Set / 1000 % 10;
       if(Val > 0)
        {
   ...
   if (speed[3].Display_Set > 99) // 大于99时
   {
       Val = speed[3].Display_Set / 100 % 10;
       switch (Val)
       {
       case 0:
   ...
   if (speed[3].Display_Set > 9) // 大于9时
   {
        Val = speed[3].Display_Set / 10 % 10;
        switch (Val)
        {
            case 0:
    ...
    /**********工位4的实际温度显示**********/
    if (temp[3].Display_Rel >= 0)//大于等于0时
    {
        Val = temp[3].Display_Rel / 1000 % 10;
    }
    else if (temp[3].Display_Rel < 0 && temp[3].Display_Rel > -100)
    {
        Val = ABS(temp[3].Display_Rel) / 1000 % 10;//计算后是0，不大于999所以不会显示
    }
    else if (temp[3].Display_Rel <= -100 && temp[3].Display_Rel > -1000)
    {
        Val = 10;//显示“-”
    }
    switch (Val)
    ...
    {
        Val = ABS(temp[3].Display_Rel)/ 100 % 10;
    }
    switch (Val)
    {
        case 0:
            if (temp[3].Display_Rel > 99)//显示零
            {
    ...
    if (temp[3].Display_Rel >= 0)//大于等于0时
    {
        Val = temp[3].Display_Rel / 10 % 10;
    }
    else if (temp[3].Display_Rel < 0 && temp[3].Display_Rel > -100)
    {
        Val = ABS(temp[3].Display_Rel) / 10 % 10;
    }
    else if (temp[3].Display_Rel <= -100 && temp[3].Display_Rel > -1000)
    {
        Val = ABS(temp[3].Display_Rel) / 10 % 10;
    ...
    /**********工位4的设定温度显示**********/
    if (temp[3].Display_Set >= 0)//大于等于0时
    {
        Val = temp[3].Display_Set / 1000 % 10;
    }
    else if (temp[3].Display_Set < 0 && temp[3].Display_Set > -100)
    {
        Val = ABS(temp[3].Display_Set) / 1000 % 10;//计算后是0，不大于999所以不会显示
    }
    else if (temp[3].Display_Set <= -100 && temp[3].Display_Set > -1000)
    {
        Val = 10;//显示“-”
    }
    switch (Val)
    ...
    {
        Val = ABS(temp[3].Display_Set)/ 100 % 10;
    }
    switch (Val)
    {
        case 0:
    ...
    if (temp[3].Display_Set >= 0)//大于等于0时
    {
        Val = temp[3].Display_Set / 10 % 10;
    }
    else if (temp[3].Display_Set < 0 && temp[3].Display_Set > -100)
    {
        Val = ABS(temp[3].Display_Set) / 10 % 10;
    }
    else if (temp[3].Display_Set <= -100 && temp[3].Display_Set > -1000)
    {
        Val = ABS(temp[3].Display_Set) / 10 % 10;
    ...
    bit_Cal(43, 0x20, 0x20);
     ...
     /**********工位4的实际时间显示**********/
    Val = time[3].Display_Rel / 3600 / 10;//计算十位为单位的小时数
    switch (Val)
    {
        case 0:
    ...
    Val = time[3].Display_Rel / 3600 % 10;// 计算个位为单位的小时数
    switch (Val)
    {
        case 0:
    ...
    Val = time[3].Display_Rel % 3600 / 60 / 10; // 计算十分位为单位的分钟数
    switch (Val)
    {
        case 0:
    ...
    Val = time[3].Display_Rel % 3600 / 60 % 10;	// 计算个分位为单位的分钟数
    switch (Val)
    {
        case 0:
    ...
    /**********工位3的设定时间显示**********/
    Val = time[3].Display_Set / 3600 / 10;//计算十位为单位的小时数
    switch (Val)
    {
         case 0:
    ...
    Val = time[3].Display_Set / 3600 % 10;// 计算个位为单位的小时数
    switch (Val)
    {
        case 0:
    ...
    Val = time[3].Display_Set % 3600 / 60 / 10; // 计算十分位为单位的分钟数
    switch (Val)
    {
        case 0:
    ...
    Val = time[3].Display_Set % 3600 / 60 % 10;	// 计算个分位为单位的分钟数
    switch (Val)
    {
        case 0:
...
{
    Display_IC1(Speed,Temp,Time);
    Display_IC2(Speed,Temp,Time);
}
