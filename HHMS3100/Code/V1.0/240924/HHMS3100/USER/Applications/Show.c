...
void Display_IC2(_Work_Num_ work_num[])
{
   ...
   else
   {
    ...
    else
    {
        ...
        {
            bit_Cal(11, 0x01, 0x00);bit_Cal(12, 0x01, 0x00);//不显示
            bit_Cal(13, 0x03, 0x00);bit_Cal(14, 0x07, 0x02);bit_Cal(15, 0x03, 0x00);//显示“-”
            bit_Cal(16, 0x03, 0x00);bit_Cal(17, 0x07, 0x02);bit_Cal(18, 0x03, 0x00);//显示“-”
            bit_Cal(19, 0x01, 0x00);//不显示
        }
        else
        {
   ...
   else
   {
    ...
    else
    {
        ...
        {
            bit_Cal(31, 0x01, 0x00);bit_Cal(32, 0x01, 0x00);//不显示
            bit_Cal(33, 0x03, 0x00);bit_Cal(34, 0x07, 0x02);bit_Cal(35, 0x03, 0x00);//显示“-”
            bit_Cal(36, 0x03, 0x00);bit_Cal(37, 0x07, 0x02);bit_Cal(38, 0x03, 0x00);//显示“-”
            bit_Cal(39, 0x01, 0x00);//不显示
        }
        else
        {
...
void Display_IC1(_Work_Num_ work_num[])
{
   ...
   else
   {
    ...
    else
    {
        ...
        {
            bit_Cal(69, 0x01, 0x00);bit_Cal(68, 0x01, 0x00);//不显示
            bit_Cal(67, 0x01, 0x00);bit_Cal(66, 0x01, 0x00);bit_Cal(65, 0x03, 0x01);bit_Cal(64, 0x03, 0x00);bit_Cal(63, 0x01, 0x00);//显示“-”
            bit_Cal(63, 0x06, 0x00);bit_Cal(62, 0x07, 0x02);bit_Cal(61, 0x03, 0x00);//显示“-”
            bit_Cal(60, 0x02, 0x00);//不显示
        }
        else
        {
   ...
   else
   {
    ...
    else
    {
        ...
        {
            bit_Cal(49, 0x01, 0x00);bit_Cal(48, 0x01, 0x00);//不显示
            bit_Cal(47, 0x01, 0x00);bit_Cal(46, 0x01, 0x00);bit_Cal(45, 0x03, 0x01);bit_Cal(44, 0x03, 0x00);bit_Cal(43, 0x01, 0x00);//显示“-”
            bit_Cal(43, 0x06, 0x00);bit_Cal(42, 0x07, 0x02);bit_Cal(41, 0x03, 0x00);//显示“-”
            bit_Cal(40, 0x02, 0x00);//不显示
        }
        else
        {
    ...
    /**********工位4的设定温度显示**********/
    if(Temp_ShowFlag && EC11A[1].EC11A_Knob <= 0 && sys.New_Work == 3)//不显示设定温度
    {
        bit_Cal(49, 0x1C, 0x00);bit_Cal(48, 0x0E, 0x00);bit_Cal(47, 0x02, 0x00);//第一位不显示
        ...
        bit_Cal(42, 0x38, 0x00);bit_Cal(41, 0x1C, 0x00);bit_Cal(40, 0x08, 0x00);//第四位不显示
    }
    else
    {
    ...
    /**********工位3的设定时间显示**********/
    if(Time_ShowFlag && EC11A[1].EC11A_Knob <= 0 && sys.New_Work == 3)//不显示设定时间
    {
        bit_Cal(49, 0xE0, 0x00);bit_Cal(48, 0xF0, 0x00);//第一位不显示
        bit_Cal(47, 0xE0, 0x00);bit_Cal(46, 0xF0, 0x00);//第二位不显示
        bit_Cal(45, 0xC0, 0x00);bit_Cal(44, 0xE0, 0x00);bit_Cal(43, 0xC0, 0x00);//第三位不显示
        bit_Cal(42, 0xC0, 0x00);bit_Cal(41, 0xE0, 0x00);bit_Cal(40, 0x60, 0x00);//第四位不显示
    }
    else
    {
