 ...
 */
void Display_IC2(uint8_t i, _Work_Num_ work_num[])
{
...
void Display_IC1(uint8_t i, _Work_Num_ work_num[])
{
    uint8_t Val;// 用于百十个取出来的数字
...
//        Work_Num[0].Temp.Display_Rel = Work_Num[0].Temp.Rel;
//        Work_Num[1].Temp.Display_Rel = Work_Num[1].Temp.Rel;
//        Work_Num[2].Temp.Display_Rel = Work_Num[2].Temp.Rel;
//        Work_Num[3].Temp.Display_Rel = Work_Num[3].Temp.Rel;
//        Display_IC2(j,Work_Num);
//        Display_IC1(j,Work_Num);
