...
uint8_t Speed_ModeFlag;//速度模式显示
uint8_t Xg_Mode;//模块型号
uint16_t Xg_MAX,Speed_MAX;//离心率最大值
...
uint16_t Safe_Set_Temp;//安全设定温度
uint16_t Safe_Rel_Temp;//安全实际温度
uint16_t Display_SafeTemp;//显示安全温度
