...
#define Clr_1625_Cs  HAL_GPIO_WritePin(Ht1621_CS_GPIO_Port, Ht1621_CS_Pin, GPIO_PIN_RESET)
#define Set_1625_Cs  HAL_GPIO_WritePin(Ht1621_CS_GPIO_Port, Ht1621_CS_Pin, GPIO_PIN_SET)

#define Clr_1625_Wr  HAL_GPIO_WritePin(Ht1621_WR_GPIO_Port, Ht1621_WR_Pin, GPIO_PIN_RESET)
#define Set_1625_Wr  HAL_GPIO_WritePin(Ht1621_WR_GPIO_Port, Ht1621_WR_Pin, GPIO_PIN_SET)

#define Clr_1625_Dat HAL_GPIO_WritePin(Ht1621_DAT_GPIO_Port, Ht1621_DAT_Pin, GPIO_PIN_RESET)
...
void Write_Addr_Dat_N(uint8_t _addr, uint8_t _dat, uint8_t n);//屏幕显示
