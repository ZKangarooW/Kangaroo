...
void Param_Reset(void)
{
	...
	/***************CGF*******************/
    Param.P_Param[1][0] = 840;//时间
    Param.P_Param[1][1] = 2350;//转速
    Param.P_Param[2][1] = 2070;//转速
    Param.P_Param[3][1] = 2350;//转速
    Param.P_Param[4][1] = 2590;//转速
    /***************PrP*******************/
    Param.P_Param[5][0] = 300;//时间
    Param.P_Param[5][1] = 3780;//转速
    /***************APrF******************/
    Param.P_Param[6][0] = 720;//时间
    Param.P_Param[6][1] = 1250;//转速
    /***************IPrF******************/
    Param.P_Param[7][0] = 300;//时间
    Param.P_Param[7][1] = 640;//转速
	#endif
