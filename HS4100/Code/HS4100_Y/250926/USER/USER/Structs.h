...
typedef struct
{
	...
	uint16_t Ctrl;//控制温度（期望值）
	int16_t Set;//设置温度
	uint16_t Rel;//实际温度
	uint16_t Mesa;//台面温度
	uint16_t Outside;//外部温度
	uint16_t Display_Rel;//用于显示实际温度
	uint16_t Display_Set;//用于显示设置温度
