...
{	
    ...
    int16_t Speed[Motor_Num];//速度
    int16_t Temp[Motor_Num];//温度
    int32_t Time[Motor_Num];//时间
    
    float Correct[Motor_Num];//温度系数
    uint8_t Calibration;
};
...
void Param_Save_Overtime(float dT);//保存标志位置1，0.5s后保存ganm
