...
void Calibration_Init(void)
{
    ...
    && PT_VALUE_1_TEMP[2]>990 && PT_VALUE_1_TEMP[2]<1010 && PT_VALUE_1_TEMP[3]>990 && PT_VALUE_1_TEMP[3]<1010 
	&& PT_VALUE_1_TEMP[4]>990 && PT_VALUE_1_TEMP[4]<1010 && PT_VALUE_1_TEMP[5]>990 && PT_VALUE_1_TEMP[5]<1010 && Param.Calibration == 0) 
    {
    ...
    if(PT_VALUE_1_TEMP[0]>990 && PT_VALUE_1_TEMP[0]<1010 && PT_VALUE_1_TEMP[1]>990 && PT_VALUE_1_TEMP[1]<1010
    && PT_VALUE_1_TEMP[2]>990 && PT_VALUE_1_TEMP[2]<1010 && PT_VALUE_1_TEMP[3]>990 && PT_VALUE_1_TEMP[3]<1010
	&& PT_VALUE_1_TEMP[4]>990 && PT_VALUE_1_TEMP[4]<1010 && PT_VALUE_1_TEMP[5]>990 && PT_VALUE_1_TEMP[5]<1010	&&HAL_GPIO_ReadPin(EC11A[0].Key_GPIO,EC11A[0].Key_Pin) == KEY_DOWN)
    {
        Calibration.Switch = 1;//如果开机按住P和Menu按键就打开校准
        Param.Calibration = 0;
