...
void EC11A_Init(void)
{
	...
	EC11A[0].EC11A_A_Pin = KEY1A_Pin;//EC11A旋钮输入引脚
	EC11A[0].EC11A_A_GPIO = KEY1A_GPIO_Port;//EC11A旋钮输入GPIO端口
	EC11A[0].EC11A_B_Pin = KEY1B_Pin;//EC11A旋钮输入引脚
	EC11A[0].EC11A_B_GPIO = KEY1B_GPIO_Port;//EC11A旋钮输入GPIO端口
	...
	EC11A[1].EC11A_A_Pin = KEY2A_Pin;//EC11A旋钮输入引脚
	EC11A[1].EC11A_A_GPIO = KEY2A_GPIO_Port;//EC11A旋钮输入GPIO端口
	EC11A[1].EC11A_B_Pin = KEY2B_Pin;//EC11A旋钮输入引脚
	EC11A[1].EC11A_B_GPIO = KEY2B_GPIO_Port;//EC11A旋钮输入GPIO端口
