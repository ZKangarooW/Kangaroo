...
/**********宏定义************/
#define EC11A_Tim_1 htim6//旋钮1的定时器
#define EC11A_Tim_2 htim14//旋钮2的定时器

#define EC11A_FastSpeed 100//旋钮快转的值
#define EC11A_DEBOUNCE_DELAY 2  // 消抖延时时间(ms)
...
void EC11A_TIM_Interrupt(TIM_HandleTypeDef *htim);//EC11A旋钮定时计数中断函数
