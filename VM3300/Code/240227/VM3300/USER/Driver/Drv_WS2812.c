...
//		if (step == 0)
			WS2812_SetColor(8, 0xFF, 0, 0);
//		else if (step == 1)
//			WS2812_SetColor(0xFF, 0, 0xFF, 0);
//		else
//			WS2812_SetColor(0xFF, 0xFF, 0xFF, 0xFF), led_check = 0, WS2812_Status[0].Mode = 1;
//	}
//	else
//	{
...
//	WS28121_SetColor(2, 0, 0xFF, 0);
//	WS28121_SetColor(3, 0, 0, 0xFF);
