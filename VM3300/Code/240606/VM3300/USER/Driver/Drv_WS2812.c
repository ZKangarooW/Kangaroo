...
//    static uint32_t Start_Num = 23;
//    static uint32_t Stop_Num = 0;
//    static uint32_t Beat_Setp = 0;
...
//                led_check = 0;
//            }
//            Beat_Setp = Start_Num - Stop_Num;
//        }
//        else
//        {
//            WS2812_SetColor(Beat_Setp, 0xFF, 0xFF, 0xFF);
//            Beat_Setp -- ;
//            if(Beat_Setp == 0)
//                Stop_Num ++;
//        }
...
//	else
//	{
		WS2812_SetColor(7, 0xFF,0xFF, 0xFF);
//	}
    
//	WS28121_SetColor(0, 0xFF, 0, 0);
//    WS28121_SetColor(1, 0xFF, 0, 0);
